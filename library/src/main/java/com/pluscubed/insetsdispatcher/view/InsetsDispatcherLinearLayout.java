...
public class InsetsDispatcherLinearLayout extends LinearLayout implements InsetsDispatcherViewGroup {

    private InsetsDispatcherHelper mHelper;


    public InsetsDispatcherLinearLayout(Context context) {
        this(context, null, 0);
    }

    public InsetsDispatcherLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InsetsDispatcherLinearLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public class LayoutParams extends LinearLayout.LayoutParams implements InsetsDispatcherLayoutParams {

...
public class InsetsDispatcherRelativeLayout extends RelativeLayout implements InsetsDispatchReceiver {
    ...
    public InsetsDispatcherRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InsetsDispatcherRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
